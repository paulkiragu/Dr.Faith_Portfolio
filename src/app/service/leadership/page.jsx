...
import { leadershipIntro, leadershipAreas } from '@/data/serviceData';
import { Shield } from 'lucide-react';

export const metadata = {
  title: 'Dr. Faith Mueni | Leadership & Administration',
  description: 'Leadership and administrative experience of Dr. Faith Mueni.',
};
          ...
          {leadershipAreas.map((item) => (
            <div key={item.id} className="rounded-lg p-5" style={{ backgroundColor: '#ffffff' }}>
              <div className="w-9 h-9 rounded-full flex items-center justify-center mb-3"
                ...
                <Shield size={17} style={{ color: '#2a9d8f' }} />
              </div>
