...
import { supervisionIntro, supervisionPhilosophy } from '@/data/teachingData';
import { GraduationCap } from 'lucide-react';

export const metadata = {
  title: 'Dr. Faith Mueni | Postgraduate Supervision',
  description: 'Postgraduate supervision philosophy and approach of Dr. Faith Mueni.',
};
  ...
  return (
    <div style={{ backgroundColor: '#E8F3EA' }} className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <p
          className="text-sm leading-relaxed mb-2 max-w-3xl"
          style={{ fontFamily: "'Lora', serif", color: '#1b2a38' }}
        >
          {supervisionIntro.description}
        </p>
        <p
          className="text-sm leading-relaxed mb-8 max-w-3xl"
          style={{ fontFamily: "'Lora', serif", color: '#1b2a38' }}
        >
          {supervisionIntro.closing}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {supervisionPhilosophy.map((item) => (
            <div
              key={item.id}
            ...
            >
              ...
              >
                <GraduationCap size={17} style={{ color: '#2a9d8f' }} />
              </div>
              <h4
